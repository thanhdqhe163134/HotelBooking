...
<body style="background: url('images/banner2.jpg') no-repeat center center fixed; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover; backdrop-filter: blur(100px);">
<div class="container">
    <a href="home" class="logo" target="_blank">
                                        ...
                                        <div class="section text-center">
                                            ...
                                            <% } %>
                                                ...
                                                <div class="form-group">
                                                    <input type="text" name="username" class="form-style" placeholder="Username" id="logemail" autocomplete="off" required value="${username}">
...
<script>
    window.onload = function() {
        var signUp = '<%=request.getAttribute("signUp")%>';
        if (signUp == 'true') {
